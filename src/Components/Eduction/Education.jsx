...
export const Education = () => {
  ...
  return (
    <section >
        ...
        <h1 data-aos="fade-up" className="text-5xl font-extrabold uppercase text-[var(--headings)] border-b-2 border-[var(--border)] py-7">social links</h1>
        <div id='social-content' className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        {
          sociaData.map((elem ,index)=>{
            return <a data-aos="zoom-in" href={elem.link} key={index} className="p-4 rounded-md relative cursor-pointer social-cont overflow-hidden border-2 border-[var(--textclr)] bg-[var(--socialbg)] mt-[5vh]">
